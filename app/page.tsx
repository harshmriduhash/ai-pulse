      ...
      <header className="px-4 lg:px-6 h-16 flex items-center fixed w-full bg-[#000000] bg-opacity-80 backdrop-blur-md z-50">
        ...
        <nav className="hidden md:flex items-center ml-auto gap-4 sm:gap-6">
          {["About", "Contact", "Blog", "Support"].map((item) => (
            <Link
              key={item}
              className="text-sm font-medium hover:text-[#50E3C2] transition-colors"
              href="#"
            >
              {item}
            </Link>
          ...
          <Link
            href="/auth/login"
            className="bg-transparent border border-[#50E3C2] text-[#50E3C2] hover:bg-[#50E3C2] hover:text-black transition-all duration-300 h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
          >
            Login
          </Link>
        </nav>
          ...
          >
            <nav className="flex flex-col items-center gap-6">
              {["About", "Contact", "Blog", "Support"].map((item) => (
                <Link
                  key={item}
                  className="text-2xl font-medium hover:text-[#50E3C2] transition-colors"
                  href="#"
          ...
          >
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              >
                <Button
                  type="submit"
                  className="bg-transparent border border-[#50E3C2] text-[#50E3C2] hover:bg-[#50E3C2] hover:text-black transition-all duration-300"
                >
                  Learn More
                ...
                <Link
                  href="\auth\login"
                  className="bg-[#50E3C2]  text-black border border-[#50E3C2] hover:bg-[#50E3C2] hover:text-black transition-all duration-300 h-9 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
                >
                  Get Started
                </Link>
              </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Select from a wide range of AI topics that matter to you.",
                },
                {
                  icon: <Zap className="h-10 w-10 text-[#4FACFE]" />,
                  title: "We Curate the Best",
                  description:
                    "Our AI algorithms find the most relevant and impactful updates.",
                },
                {
                  icon: <Mail className="h-10 w-10 text-[#50E3C2]" />,
                  title: "Receive Timely Updates",
                  description:
                    "Get personalized digests daily, weekly, or monthly - you choose.",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
            ...
            <div className="grid gap-10 lg:grid-cols-2 items-center">
              ...
              >
                ...
                <p className="text-gray-300">
                  AI Pulse brings you curated insights from the forefront of
                  artificial intelligence. Whether you're a researcher,
                  entrepreneur, or enthusiast, we've got you covered.
                </p>
              ...
              {[
                {
                  ...
                  description:
                    "Accelerating discoveries and data analysis in various scientific fields.",
                },
                {
                  icon: <Tractor className="h-10 w-10 text-[#4FACFE]" />,
                  title: "Agriculture",
                  description:
                    "Optimizing crop yields and resource management with AI-driven insights.",
                },
                {
                ...
                },
                {
                  ...
                  title: "Business",
                  description:
                    "Enhancing decision-making and automating complex business processes.",
                },
                {
                  icon: <Stethoscope className="h-10 w-10 text-[#50E3C2]" />,
                  title: "Healthcare",
                  description:
                    "Revolutionizing diagnostics, treatment plans, and patient care.",
                },
                {
                  icon: <ShieldCheck className="h-10 w-10 text-[#4FACFE]" />,
                  title: "Cybersecurity",
                  description:
                    "Strengthening defenses against evolving digital threats and vulnerabilities.",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid gap-10 lg:grid-cols-2 items-center">
              ...
              >
                ...
                <p className="text-gray-300">
                  Don't miss out on the latest AI advancements. Join our
                  newsletter now and stay at the forefront of innovation.
                </p>
                ...
                <form className="flex space-x-2">
                  ...
                  <Button
                    type="submit"
                    className="bg-[#50E3C2] hover:bg-[#4FACFE] text-black transition-all duration-300"
                  >
                    Subscribe
        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col sm:flex-row justify-between items-center">
          ...
          <nav className="flex gap-4 sm:gap-6 mt-4 sm:mt-0">
            {["Terms", "Privacy", "Contact"].map((item) => (
              <Link
                key={item}
                className="text-sm text-gray-400 hover:text-[#50E3C2] transition-colors"
                href="#"
              >
                {item}
              </Link>
